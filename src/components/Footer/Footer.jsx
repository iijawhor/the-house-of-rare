...
function Footer() {
  return (
    <section className="flex relative px-10 border-t-2 border-gray-800 h-fit md:h-72 py-10 bg-sky-950">
      <div className="flex w-full flex-wrap justify-between items-center md:gap-auto md:gap-0 gap-5 ">
        <div className="flex flex-col gap-2">
          <p className="text-base font-jost font-light tracking-widest uppercase">
            The House Of Rare
          </p>
